...
import os, sys #Both gives the ability to work with files
...
t = Tap(log_level=logging.DEBUG) # A class defined in the tap file, Instantiation Tap object defined in tap.py
t.reset()
t.reset2ShiftIR()
